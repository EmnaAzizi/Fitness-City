				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="heading-section text-center animate-box">
                                                    ...
                                                    <h2>Réservations sous le nom de <span style="color:green" ><?php echo $_SESSION["nom"];?></span></h2>
    <div class="custyle">
...
$sql="Select * from reservation where login_client='".$_SESSION["login"]."'";
...
?>  
                ...
                <th style="font-weight: normal;"><?php echo $row["nom_cours"]; ?></th>
                <th style="font-weight: normal;"><?php echo $row["Jour"]; ?></th>
                <td class="text-center"><a href="delete.php?id=<?php echo $row["id"]?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Supprimer <span class="glyphicon glyphicon-trash"></span></a></td>
            </tr>
                 <?php
    }
